"""
Objective: Create a simplified Python script that uses 
conditional statements, Match Case, and loops 
...
Print a reminder about the task that includes 
its priority level and whether immediate action is required based on time sensitivity.
...
match priority:
    case "high":
        ...
        print(f"Note: {task} is a high priority task{message}")
    case "medium":
        if time_bound == 'yes':
            message = ' that requires immediate attention today!'
        elif time_bound == 'no':
            message = ". Consider completing it when you have free time."
        print(f"Note: {task} is a medium priority task{message}")
    case "low":
        if time_bound == 'yes':
            message = ' that requires immediate attention today!'
        elif time_bound == 'no':
            message = "Consider completing it when you have free time."
        print(f"Note: {task} is a low priority task{message}")

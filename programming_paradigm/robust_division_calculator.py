"""
Objective: Implement a division calculator that robustly handles errors like 
...
Expected Behavior:
The script is executed from the command line with two additional arguments 
representing the numerator and denominator. Here are sample commands and the expected outputs:
